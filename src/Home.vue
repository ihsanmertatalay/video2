<template>
  ...
  <main>
    ...
    <Navbar :name="myuser.name" style="height: 9vh;" />

    <div class="container-fluid"
      style="display: flex; width: 100%; padding: 0%; background: whitesmoke; overflow: hidden;">

      <div class="mt-5" style="width: 80%">
        <div class="container-fluid" style="display: flex; justify-content: center">
          <div class="box" @click="routeAnlat('/anlat/')">
            <h1 style="color: #336699">Anlat</h1>
            <i class="fa-solid fa-person-chalkboard" style="color: #336699; font-size: 30px; margin-bottom: 30px"></i>
          </div>

          <div class="box" @click="routeDinle()" style="border-radius: 0px 5px 5px 0px; border-right: none;">
            <h1 style="color: #4e95dc">Dinle</h1>
            <i class="fa-solid fa-chalkboard-user" style="color: #4e95dc; font-size: 30px; margin-bottom: 30px"></i>
          </div>
        </div>
        <div class="container-fluid" style="display: flex; justify-content: center">
          ...
          <div class="box" @click="routeAnlat('/cevapla/')" style="border-radius: 0px 5px 5px 0px; border-right: none;">
            <h1 style="color: rgb(250, 226, 160)">Cevapla</h1>
            <i class="fa-solid fa-message" style="
...
.box {
  ...
  border-right: 0.1px solid rgb(188, 187, 187);
